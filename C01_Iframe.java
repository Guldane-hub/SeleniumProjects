...
String actual = driver.findElement(By.xpath("//*[.='An iframe with a thin black border:']")).getText();
        //Assertions.assertTrue(actualText.cntains("black border"));
   ...
   /*
    Bir HTML dökümani icinde yerlestirilmis olan baska bir HTML dökümanina Inline Frame (iframe) denir
    Sayfadaki bir webelementi locate ettigimizde NoSuchElement Exception aliyorsak locate i kontrol ederiz
    ve yine ayni hatayi aliyorsak ulasmak istedgimiz webelement iframe icinde olabilir
    Dolayisiyla iframe icindeki bir webelemente ulasmak icin driverimizi iframe gecirmemiz gerekir

    3 sekilde bunu yapabiliriz
