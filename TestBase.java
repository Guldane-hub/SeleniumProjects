...
//ben simdi burada abstarct yaparsam kurulan child classlarin beni extend etmesini zorunlu kilabilirim
//eger obje kurmak istemiyorsak
    ...
    public void amazonKepceBye() {
        WebElement kepceLink = driver.findElement(By.linkText("Try different image"));
        if (kepceLink.isDisplayed()) {
            kepceLink.click();
        }
